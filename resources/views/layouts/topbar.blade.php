            ...
            <div class="float-right">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle header-profile-user" src="{{asset('images/users/avatar-4.jpg')}}" alt="admin">
                        <span class="d-none d-xl-inline-block ml-1">{{  Auth::user()->name }}</span>
                        <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                    </button>
                    <div class="dropdown-menu dropdown-menu-right">
                        <!-- item-->
                        {{-- <a class="dropdown-item" href="pages-profile"><i class="bx bx-user font-size-16 align-middle mr-1"></i> Profile</a> --}}
                ...
                <div class="navbar-brand-box">
                    ...
                    <a href="index" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                           ...
                           <h4 class="text-white pt-3">Dashboard</h4> 
                        </span>
                    </a>
                </div>
