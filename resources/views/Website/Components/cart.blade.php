                                ...
                                @foreach ($result as $item)
                                    @php
                                        ...
                                        $product_image = DB::table('product_images')
                                            ...
                                            ->first();
                                    @endphp
                                    <td><img src="{{ asset($product_image) }}" alt="product image"
                                            class="cart-img">
                                    </td>
                                    <td class="align-middle">{{ $item->product_name }}</td>
                                    <td class="align-middle">  
                                        @if ($item->special_price != null)
                                       <span class="mr-3"> <del><i class="fas fa-rupee-sign"></i>{{ $item->price }} <del></span> <i class="fas fa-rupee-sign"></i> {{ $item->special_price }} 
                                    @else
                                    ...
                                    <td class="align-middle"> <a  href="{{url('remove-card/'.$item->products_id)}}"> <i class="far fa-window-close"></i> </a></td>
                            </tr>
@endforeach
{{-- <tr>
...
<section class="container-fluid  page-middle-section border-bottom">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <p class="text-success text-center">Your Cart is empty</p>
                <p class="text-center"> <a href="{{ url('/') }}" class="btn btn-dark">Add Items To Cart</a>
                </p>
            </div>
        </div>
    </div>
