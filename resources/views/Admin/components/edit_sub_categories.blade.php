    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="col-md-8 m-auto">
                ...
                @csrf 
			<input type="hidden" class="form-control" name="id" value="{{$SubCategories->id}}" required>
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="category_id" required>
                                ...
                                @foreach($Categories as $r) 
                                    <option value="{{$r->id}}" @if($r->id == $SubCategories->category_id)selected @endif>{{$r->category_name}}</option> 
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="sub_category_name"  placeholder="Enter Test Section Name" value="{{$SubCategories->sub_category_name}}" required/>
                        </div>
                    </div> 
                    
                    @if($SubCategories->sub_category_image)
                    <div class="form-group row ">
                        <label class="form-label col-md-3 p-2">Preview</label>
                        <div class=" col-md-9">                                  
                           <img class="document_img" src="{{asset($SubCategories->sub_category_image)}}" alt="" width="80" height="80">
                        </div>                                
                    </div>
                    @endif
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="file" name="sub_category_image_new">                            
                        </div>
