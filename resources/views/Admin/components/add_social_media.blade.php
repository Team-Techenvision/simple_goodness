            ...
            <div class="col-md-8 m-auto">
                ...
                @csrf 
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="social_media_name" required placeholder="Enter Social Media Name" required/>
                        </div>
                    </div>  
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="link" required placeholder="Enter Social Media Link" required/>
                        </div>
                    </div>  
