        ...
        <div class="card-body">
            ...
            <div class="col-md-8 m-auto">                                       
                ...
                <input type="hidden" name="blog_id" value="{{$blogs->id}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">                            
                                <div>
                                    <textarea id="elm1"  class="form-control" rows="3" name="blog_content" placeholder="Enter Content">{{$blogs->blog_content}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Blog Written By</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="blog_written_by_name" value="{{ $blogs->user->name }}" readonly/>
