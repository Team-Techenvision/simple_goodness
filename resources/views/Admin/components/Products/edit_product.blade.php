            ...
            <div class="col-md-8 m-auto">                                       
                ...
                <input type="hidden" name="products_id" value="{{ $product->products_id }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="product_code"  placeholder="Enter Product Code" value="{{$product->product_code}}" required/>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Product Form </label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="product_form"  placeholder="Enter Product Form Powder, Solid, Oil etc" value="{{$product->product_form}}" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="product_size"  placeholder="Enter Product size" required  value="{{$product->size}}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="price"  placeholder="Enter Price" required  value="{{$product->price}}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="special_price"  placeholder="Enter Special Price if Any"  value="{{$product->special_price}}" />
                        </div>
                    </div>
