            ...
            <div class="col-md-8 m-auto">                                       
                ...
                @csrf 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="product_form"  placeholder="Enter Product Form Powder, Solid, Oil etc" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="special_price"  placeholder="Enter Special Price if Any" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="key_words"  placeholder="Enter Keywords" />
                        </div>
                    </div>
